...
badass.push([
    ...
    "Throughout her long and varied career as a poet, playwright and novelist, Anne H&egrave;bert earned a list of accolades that basically makes her the Beyonc&egrave; of French-Canadian literature. Plus, this single lady won the Governor General's Award three times. And she was appointed a Companion of the Order of Canada. Who run the world, indeed.",
    "img/anne-hebert"
]);
badass.push([
    "Carrie Derick",
...
badass.push([
    ...
    "\"Ew, blood!\" said Dr. Elizabeth Smellie never. After patching up the WWII wounded, Elizabeth hit up McGill University to teach another generation of nurses how to kick ass. You know&hellip; medically speaking. After that, in competition only with herself, Lizzy served as the first female colonel in the Canadian army as the medical corps' matron-in-chief in WWII. Yeah, \"matron-in-chief.\" AKA: Lady. Boss.",
